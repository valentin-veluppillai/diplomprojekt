...
#define LDRED_Pin GPIO_PIN_4
#define LDRED_GPIO_Port GPIOD
#define LDYEL_Pin GPIO_PIN_5
#define LDYEL_GPIO_Port GPIOD
#define LDGRE_Pin GPIO_PIN_6
#define LDGRE_GPIO_Port GPIOD
